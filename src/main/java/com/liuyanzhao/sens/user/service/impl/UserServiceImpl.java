...
import com.liuyanzhao.sens.user.common.constant.RedisKeyExpire;
import com.liuyanzhao.sens.user.common.constant.RedisKeys;
import com.liuyanzhao.sens.user.common.enums.CommonParamsEnum;
import com.liuyanzhao.sens.user.common.enums.RoleEnum;
import com.liuyanzhao.sens.user.common.enums.TrueFalseEnum;
import com.liuyanzhao.sens.user.common.exception.SensBusinessException;
...
import com.liuyanzhao.sens.user.mapper.UserMapper;
...
public class UserServiceImpl implements UserService2 {
    ...
    public Integer updateUserLoginError(User user) {
        user.setLoginError((user.getLoginError() == null ? 1 : user.getLoginError()) + 1);
